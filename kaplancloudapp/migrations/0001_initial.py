    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True, related_name="pm", to=settings.AUTH_USER_MODEL
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "target_bilingualfile",
                    models.FileField(
                        blank=True, upload_to=kaplancloudapp.utils.get_target_file_path
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("due_by", models.DateTimeField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "status",
                    models.IntegerField(
                        choices=[(0, "Blank"), (1, "Draft"), (2, "Translated")],
                        default=0,
                    ),
                ),
                (
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                to="kaplancloudapp.translationmemory",
            ),
        ),
        migrations.AddField(
            model_name="tmentry",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True, to="kaplancloudapp.TranslationMemory"
            ),
        ),
        migrations.CreateModel(
